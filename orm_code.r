...
#### estiamte conditional CDF and its standard error for orm models
...
###### Figure 9 (i) error ~ Normal, Table S.4 (i) error ~ Normal
...
###### Figure  10 (i) error ~ Normal, Table S.5 (i) error ~ Normal
...
###### Figure 9 (ii) error ~ extreme value (type I), Table S.4 (ii) error ~ extreme value (type I)
...
###### Figure  10 (ii) error ~ extreme value (Type I), Table S.5 (ii) error ~ extreme value (Type I)
...
###### Figure 11, Tables S.10 and S.11
...
############### Figure 12; Tables S.13 and S.14 ###################
...
###### Table S.18
latex(tab.s2.out, where="!htbp", file="", n.cgroup=c(2, 1, 2),cgroup=c("orm", "logistic regression", "linear regression"),title="below detection limits",caption="detection limimits", size="scriptsize")
...
##### Figure 14: illustrate residual-by-predictor plot ####
...
##### Figure 15: estimate conditional distribution
...
###############################################################
###### Figure S.3 estimated transformation and PSR QQ plot ##############
###############################################################
...
###################################################
####### Figure S.4: PSR by predictor plot #########
##################################################
...
############################################################################
####### Figure 16: performance of orm on estimation conditional quantiles, CDFs #########
#############################################################################
